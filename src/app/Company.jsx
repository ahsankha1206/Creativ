    ...
    <div className="container-about-1-section">
        <div className="content-about-1-section">
            <div className="image-section-about-1-section">
                <img src="my.jpeg" alt="People working together on a project with sticky notes and documents on a table" width="450" height="450" />
            </div>
            <div className="text-section-about-1-section">
                ...
                <a className="button-about-1-section" href="#">Get In Touch</a>
            </div>
        </div>
    </div>
</div>
